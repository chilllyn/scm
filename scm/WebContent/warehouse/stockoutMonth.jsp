...
<script type="text/javascript" src="script/stockoutMonth.js"></script>
...
<body>
	<div id="m">
		<table width="100%" border="0" cellpadding="0" cellspacing="0" id="m">
			<tr>
				<td nowrap class="title1">业务报表--月度出库报表</td>
			</tr>
		</table>
		...
		<p>出库单据数：<span id="orderNum">0</span></p>
		<p>出库产品总数量：<span id="numTotal">0</span></p>
		<p>出库产品总金额：<span id="priceTotal">0</span></p>
		<table width="100%" border="0" align="center" cellspacing="1"
			...
			<tr>
				...
				<td class="title1">出库数</td>
				<td class="title1">出库总金额</td>
			</tr>
		</table>
